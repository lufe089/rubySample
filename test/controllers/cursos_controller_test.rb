...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { fechaCreacionCurso: @curso.fechaCreacionCurso, nombreCurso: @curso.nombreCurso, nombreDocente: @curso.nombreDocente }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { fechaCreacionCurso: @curso.fechaCreacionCurso, nombreCurso: @curso.nombreCurso, nombreDocente: @curso.nombreDocente }
    assert_redirected_to curso_path(assigns(:curso))
  end
